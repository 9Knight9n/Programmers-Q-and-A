...
class profileThree extends Component {
  ...
  async loadFields() {
    ...
    const response = await axios.post(
      "http://404socialmedia.ir/api/show_interests/",
      form,
      {
        headers: {
  ...
  async handleSave() {
    ...
    const response = await axios.post(
      "http://404socialmedia.ir/api/editinterest/",
      form,
      {
        headers: {
          "Content-Type": "multipart/form-data",
        ...
        <div className="parisa-css w-100 pt-5 mr-5 ml-5 d-flex flex-row">
          <div className="w-50">
            <h1 className="w-100 mb-2">
              Please select Subjects you are intrested in :
            </h1>
            ...
            <div class="fileUploadInput w-100">
              ...
              <div className="w-75 d-flex flex-row">
                ...
                <button
                  ...
                  className="w-25 d-flex justify-content-center rounded-right align-items-center"
                >
                  <svg
                    width="1em"
                    height="1em"
        ...
        <div className="parisa-css bioBox mt-auto">
          ...
          <div className="parisa-css bioField d-flex justify-content-center">
            <textarea
              ...
              cols="53"
            ></textarea>
            <span className="textCounter">{this.state.pageCount} of 175</span>
          </div>
          <button
            class="profile-saveButton btn btn-primary"
            onClick={this.handleSave}
          >
            Save
          </button>
          {this.state.succeed ? (
            <p className="d-flex justify-content-center pro-success">
              Saved successfully!
            </p>
          ) : (
            <br />
