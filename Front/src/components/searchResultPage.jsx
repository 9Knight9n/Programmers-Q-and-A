            ...
            <div className="p-3 h-100">
              ...
              <div id="header" className="d-flex flex-row w-100 h-10">
                <button
                  ...
                  className={"nav-link w-25 d-flex transparent-button".concat(
                ...
                <button
                  ...
                  className="mt-2 mb-2 ml-auto mr-2 p-1 rounded"
                >
                      ...
                      >
                        {this.state.chatrooms.map((chatroom) => (
                          <Link
                            ...
                            className=" m-4"
                            to={
                              "/" + this.props.activeNav + chatroom.ChatroomID
                            }
                            onClick={() =>
                              this.props.changeChatroom(chatroom.ChatroomID)
                            }
                          >
                            <div className="d-flex flex-row result-chatroom ">
                              <img
                                className="d-flex mt-auto mb-auto mr-3 ml-3 "
                                id="chatroom-img"
                                src={chatroom.image}
                              />
                              <div className="d-flex mt-auto mb-auto pr-5">
                                {chatroom.name}
                              </div>
                            </div>
                          </Link>
