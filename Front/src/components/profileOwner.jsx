        ...
        return ( 
            ...
            <div className="chProfileOwner chProfileOwner-main-box" style={{overflowY:"hidden"}}>
                ...
                <div className="chProfileOwner-exitImg">
                                <svg src={exitImg} onClick={this.props.hideChatroomProfile} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
