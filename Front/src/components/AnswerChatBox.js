...
class AnswerChatBox extends Component {
  ...
  handleEdit = async () => {
    ...
    let config = {
      ...
      needToken: true,
      type: "post",
      formKey: ["user_id", "question", "text", "id"],
      formValue: [
  ...
  componentDidMount = async () => {
    console.log(
      "hey this is answer id : ",
      this.props.QsenderId,
  ...
  handleVote = async (up) => {
    ...
    let config = {
      ...
      needToken: true,
      type: "post",
      formKey: ["answer_id", "user_id", "voteState", "vote"],
      formValue: [
        this.state.answerId,
        sessionStorage.getItem("id"),
        voteState,
  ...
  handleTrueAnswer = async () => {
    ...
    let config = {
      ...
      needToken: true,
      type: "post",
      formKey: ["user_id", "question", "isAccepted", "id"],
      formValue: [
        sessionStorage.getItem("id"),
        this.state.Qid,
  ...
  render() {
    return (
      <div
        id="answer"
        style={{ width: this.props.width + "vw" }}
        className="answer-chatbox d-flex flex-column"
      >
        <ProfilePreview
        ...
        <div id="header" className="d-flex flex-row ">
          <div
            className="d-flex pl-2 align-top w-80 ml-3"
            className="profileAvatarBox"
          >
            <div
              style={{ cursor: "pointer" }}
              className="d-flex align-items-center mr-2 profileAvatar"
          ...
          <label
            ...
            for="profileImg"
          >
            {this.props.userName === "User is not exist"
              ? "Deleted account"
              : this.props.userName}
          </label>
          <div id="options" className="options ml-auto">
            <Dropdown className="dropDownMain">
              ...
              <Dropdown.Menu className="dropDown">
                {this.state.isOwner ? (
                  <Dropdown.Item onClick={this.showEditor} as="button">
                    Edit
                  </Dropdown.Item>
                ) : (
                  " "
                ...
                {this.state.isOwner ? (
                  <Dropdown.Item onClick={this.handleRemove} as="button">
                    Delete
                  </Dropdown.Item>
                ) : (
                  " "
            ...
            <div className="vote d-flex flex-column bd-highlight mb-3">
              ...
              >
                {this.state.PactiveVote ? (
                  <svg
                    ...
                    height="2em"
                    viewBox="0 0 16 16"
                    className="positiveVoteImg bi bi-caret-up-fill"
                    fill="currentColor"
              ...
              >
                {this.state.NactiveVote ? (
                  <svg
                    ...
                    height="2em"
                    viewBox="0 0 16 16"
                    className="negativeVoteImg bi bi-caret-down-fill"
                    fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                  ...
                  <svg
                    ...
                    height="2em"
                    viewBox="0 0 16 16"
                    className="negativeVoteImg bi bi-caret-down"
                    fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path
              ...
              <div className="trueAnswer d-flex justify-content-center mt-5">
                {this.state.isQOwner && !this.state.trueAnswer ? (
                  <svg
                    onClick={this.handleTrueAnswer}
                    data-tip="Click if this answer is true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                    fill="currentColor"
        ...
        <div id="footer" className="d-flex justify-content-around">
          <div className="form-group col-xs-4 col-md-4 p-2 w-100 bd-highlight trueAnswer  flex-column"></div>
          <div></div>
          <div className="p-2 flex-shrink-1 bd-highlight mt-auto">
            <p className="date">Submitted on: {this.state.answerSubmiteDate}</p>
          </div>
        </div>
      </div>
    );
