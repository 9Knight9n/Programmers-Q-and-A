...
class joinChatroom extends Component {
  ...
  handleJoin = async () => {
    ...
    let config = {
      ...
      formValue: [sessionStorage.getItem("id"), this.state.Cid],
    };
    let data = [];
    ...
    return (
      <div id="joinChatroom">
        {this.props.showJoinChatroom ? (
          <div
            onClick={() => this.props.hideJoinChatroom()}
            className="joinChatroom joinChatroom-main-box modal"
          >
            <section
              ...
              <div className="joinChatroom-elements">
                <div className="d-flex h-100 align-items-center flex-column">
                  ...
                  <div className="joinChatroom-text">
                    <p>Ask and answer questions then enjoy!</p>
                  </div>
                  <div className="joinChatroom-buttons d-flex flex-row mt-auto">
                    ...
                    <button onClick={this.handleJoin} className="joinButton">
                      Join
                    </button>
                  </div>
                </div>
